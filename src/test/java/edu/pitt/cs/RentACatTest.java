...
public class RentACatTest {
	...
	public void testCatAvailableTrueNumCats3() {
		...
		// Debug to ensure cat3 exists...
		assertNotNull("Cat3 does not exist when it should.", r.getCat(3));

		Mockito.when(c3.getRented()).thenReturn(true);

		assertTrue("c1 is not available when it should be available.", r.catAvailable(1));
